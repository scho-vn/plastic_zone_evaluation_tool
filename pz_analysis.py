...
from utils.functions import data_input_from_csv, sum_results, pickle_output, filter_data_input, data_input_from_dict, data_input_from_csv_mt
...
specimenlist=['dic_mt_specimen']
sidelist=['right']
for specimen_name in specimenlist:
    for side in sidelist:
        data_input = data_input_from_csv_mt(csv_filepath=os.path.join(global_path, 'data_examples', f'{specimen_name}', 'MT160_45_MDIC.csv'))
