...
class InputDataBiax:
    ...
    def read_header(self, meta_attributes_to_keywords: dict = None):
        ...
        ####rename cycles and force
        #self.cycles = self.experimental_data_cycles_catman
        self.cycles = self.experimental_data_cycles
        self.force= self.experimental_data_load_main_axis_fy
        self.cracklength= self.experimental_data_crack_tip_x_right
